...
func (p *salaRepo)GetChatUnreadMessage(ctx context.Context,chatId int64,lastUpdated string )(res []r.MessageGrupo,err error){
...
func (p *salaRepo) SaveMessage(ctx context.Context, d *r.MessageGrupo) (err error) {
...
func (m *salaRepo) fetchMessagesGrupo(ctx context.Context, query string, args ...interface{}) (res []r.MessageGrupo, err error) {
